...
**This is a bonus assignment!** As always: more is better;
healthy living is best. Only do this if you have completed the Pair Programming Bot.

As an added note: parts 6-10 are very difficult and haven't been fully covered in class. 
Therefore, if you don't understand them, it's ok. Think of the Full House App as
a project you can always come back to for practice - this is not in any way assigned.
...
## Part 7 - Mocking Persistence

We haven't learned about persisting data with databases yet, but we can still
...
1. Because URLs (and thus query params) can only use certain characters, we have
   ...
   using Ruby's standard library `URI`, already included in Rails (check it out in `pry`).
