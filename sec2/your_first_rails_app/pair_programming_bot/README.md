...
![Paired-programming bots](assets/wall-e-eve.jpg)
...
Create a Rails app and create a repo for it on Github. There is not any deep logic, 
just a series of links to implement, so you do not need to create any extra files, 
...
Write your routes' output to use correctly formatted HTML. Each page will 
...
Because the pages don't hold too much, feel free to use basic HTML.
...
![An example](assets/pair-example.png)

## Part 5 - Dynamism!

Rewrite your app to use a single dynamic route handler using route params.
