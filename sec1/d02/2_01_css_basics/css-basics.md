...
- [Here is the top listing](http://www.w3schools.com/cssref/) if you google "css properties". However, usually it is a good idea to shy away from the _w3schools_ references.
...
<head>
  <meta charset="UTF-8">
  <title>Tite Document</title>
</head>
<body>
  <h1>Holy Buckets, WDI!</h1>
</body>
</html>
```
