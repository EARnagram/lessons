...
1. I found a copy of Arnold's script and included it in the starter code. Please
fill out the "script" and model the screenplay so Arnold can tell how terrible
...
__BONUS__: Add functions to the prototype of your different constructor
functions.
